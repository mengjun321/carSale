                    ...
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-desktop"></i> 销售管理
                                <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="general_elements.jsp">车辆销售</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-th-list"></i> 库存管理
                                <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="tables.jsp">库存</a></li>
                                    <li><a href="tables_dynamic.jsp">采购</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-cny"></i> 财务管理
                                <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="chartjs.jsp">收款</a></li>
                                    <li><a href="chartjs2.jsp">付款</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-bar-chart-o"></i>报表管理
                                <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="fixed_sidebar.jsp">汽车销量</a></li>
                                    <li><a href="fixed_footer.jsp">员工销量</a></li>
                                    <li><a href="fixed_footer.jsp">财务状况</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-cog"></i> 系统管理
                                <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="chartjs.jsp">员工管理</a></li>
                                    <li><a href="chartjs2.jsp">日志信息</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
